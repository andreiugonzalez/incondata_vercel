...
const CircularChart = ({ percentage, label, subLabel, color, mainLabel }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-4 w-full h-full flex flex-col justify-between">
      <div className="text-center text-base font-bold font-zen-kaku">
        {subLabel}
      </div>
      ...
      <div className="text-center mt-2">
        ...
        <div className="text-black text-sm font-zen-kaku font-bold">
          {mainLabel}
        </div>
      </div>
    </div>
