...
import { postOrganization, postOrganizationDoc, postOrganizationProf, getPaises, getComunasPorRegion, getRegionesPorPais, getTipoEmpresa, getCodTelefono } from '@/app/services/organizacion';
...
const ExternalorganizationDrawer = ({ isOpen, onClose, userType, setModalVisible }) => {
    ...
    const validateForm = () => {
        ...
        newErrors.tipo_empresa = validateTipoEmpresa(selectedTipoEmpresa); // Agregar la validación de tipo de empresa
    ...
    // Fetch tipos de empresa
    const fetchTipoEmpresa = async () => {
        try {
            const tipos = await getTipoEmpresa();
            // Verifica que los datos estén correctos
            // Mapear y asegurar que haya un array
            setTipoEmpresaOptions(tipos.map(tipo => ({
                value: tipo.id,
                label: tipo.nombre
            })));
        } catch (error) {
    ...
    const handleTipoEmpresaChange = (option) => {
        setSelectedTipoEmpresa(option);  // Actualiza el estado visual
        setFormData((prevState) => ({
            ...prevState,
            id_tipo_empresa: option?.value || 0  // Actualiza id_tipo_empresa en formData
        }));
    };
            ...
            <div className="flex-grow justify-center items-center font-zen-kaku bg-[#FAFAFA] p-4 select-none overflow-x-hidden">
                ...
                <div className="grid items-center grid-cols-1 md:grid-cols-3 gap-4 mb-6 font-zen-kaku">
                    <label htmlFor="filtroSelect" className="ml-4 text-base font-bold text-black select-none font-zen-kaku">
                        Organización | Nueva organización externa
                    </label>
                </div>
                {/* Loader */}
                {loading && (
                ...
                {!loading && (
                    <>
                        ...
                        <div className='mx-auto bg-white shadow-lg rounded-xl flex flex-col lg:flex-row gap-2 w-full lg:w-4/5'>
                            ...
                            {step === 1 && (
                                <form className='z-50 h-full p-4 mx-auto font-zen-kaku w-full' >
                                    <>
                                        <div className='flex flex-wrap mb-6 mt-6'>
                                            <div className='w-full px-3'>
                                                ...
                                                <input
                                                    ...
                                                    aria-label="Ingresar Nombre de la empresa"
                                                    name='nombre'
                                        ...
                                        <div className='flex flex-wrap mb-6'>
                                            <div className='w-80 md:w-1/2 px-3 mb-6 md:mb-0'>
                                                ...
                                                <input
                                                    ...
                                                    aria-label="Ingresar RUT de la empresa"
                                                    name='rut'
                                                    onChange={handleInput}
                                                    value={formData.rut}
                                                />
                                        ...
                                        <div className='flex flex-wrap mb-6'>
                                            ...
                                            <div className='w-full md:w-1/2 px-3 md:mb-0'>
                                                ...
                                                <input
                                                    ...
                                                    name='codigo_postal'
                                                    aria-label='Ingresar codigo postal'
                                                    onChange={handleInput}
                                        ...
                                        <div className='flex flex-wrap mb-6'>
                                            <div className='w-full px-3 mb-6 md:mb-0'>
                                                ...
                                                <input
                                                    ...
                                                    aria-label="Ingresar representante legal"
                                                    onChange={handleInput}
                                        ...
                                        <div className='flex flex-wrap mb-6'>
                                            <div className='w-full px-3 mb-6 md:mb-0'>
                                                ...
                                                <input
                                                    ...
                                                    aria-label='Ingresar RUT responsable o representante legal'
                                                    onChange={handleInput}
                                        ...
                                        <div className='flex flex-wrap mb-6'>
                                            <div className='w-full px-3 mb-6 md:mb-0'>
                                                <Select
                                                    ...
                                                    aria-label="Seleccionar tipo de empresa"
                                                    options={tipoEmpresaOptions}
                                                    value={tipoEmpresaOptions.find(option => option.value === selectedTipoEmpresa?.value)}
                                                    onChange={handleTipoEmpresaChange}
                                                    menuPlacement="auto"
                                                    menuPosition="fixed"
                                                />
                                                {errors.tipo_empresa && <p className="text-red-500 text-sm">{errors.tipo_empresa}</p>} {/* Mostrar error */}
                                            </div>
                                        </div>
                                ...
                                <form className='mx-auto w-full p-6'>
                                    <>
                                        ...
                                        >
                                            ...
                                            />
                                            <label htmlFor="fileSii" className="px-4 py-1 ml-auto text-[#5C7891] border border-[#5C7891] rounded-md font-zen-kaku font-semibold overflow-hidden transition-transform transform-gpu hover:scale-110 cursor-pointer">
                                                Subir
                                            </label>
                                        </div>
                                        <div className='border border-b-2 shadow-xl'></div>
                                    ...
                                    <div className='flex justify-center items-center mt-36'>
                                        ...
                                        <button
                                            className="bg-[#5C7891] hover:bg-[#5c7891] font-zen text-black active:bg-[#597387] font-bold uppercase text-base px-16 py-4 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                            type="submit"
                                            onClick={nextdocstwo}
                                        >
                                            Guardar datos
                                        ...
                                        <>
                                            ...
                                            <div className='flex justify-center'>
                                                <h3 className="text-base m-5 font-zen-kaku select-none">
                                                    ¡Bienvenido a bordo!¡Comience su viaje hacia el éxito con Faena!
                                                </h3>
                                            </div>
                                        </>
                                        <div className='flex justify-center items-center mt-16'>
                                            <button
                                                className="bg-[#7FC3BB] text-white active:bg-emerald-600 hover:opacity-75 font-bold uppercase text-base px-6 py-4 rounded-md shadow-xl outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 font-zen-kaku"
...
export default ExternalorganizationDrawer;