...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addColumn('Material', 'id_organizacion', {
    ...
    await queryInterface.removeColumn('Material', 'id_proveedor');

    // Eliminar el valor por defecto de la columna id_organizacion después de asignar los valores
    await queryInterface.changeColumn('Material', 'id_organizacion', {
      type: Sequelize.INTEGER,
      allowNull: false,
      references: {
        model: 'organizacion',
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.addColumn('Material', 'id_proveedor', {
      type: Sequelize.INTEGER,
    });

    // Eliminar la columna id_organizacion de la tabla Material
    await queryInterface.removeColumn('Material', 'id_organizacion');
  }
};
